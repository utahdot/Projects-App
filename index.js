...
require(["esri/widgets/Expand",
  "esri/widgets/LayerList",
  "esri/layers/GroupLayer",
  "esri/layers/FeatureLayer",
  "esri/Map",
  "esri/views/MapView",
], function (Expand, LayerList, GroupLayer, FeatureLayer, Map, MapView) {
  const finishedLines = new FeatureLayer({
    ...
    renderer: {
      type: "simple",
      symbol: { type: "simple-line", width: 2, color: "red" },
    },
  ...
  const inDesignLines = new FeatureLayer({
    ...
    renderer: {
      type: "simple",
      symbol: { type: "simple-line", width: 2, color: "yellow" },
    },
    definitionExpression:
  ...
  const studiesLines = new FeatureLayer({
    ...
    renderer: {
      type: "simple",
      symbol: { type: "simple-line", width: 2, color: "blue" },
    },
    definitionExpression:
  ...
  const constructionLines = new FeatureLayer({
    ...
    renderer: {
      type: "simple",
      symbol: { type: "simple-line", width: 2, color: "green" },
    },
    definitionExpression:
  ...
  const substCompltLines = new FeatureLayer({
    ...
    renderer: {
      type: "simple",
      symbol: { type: "simple-line", width: 2, color: "orange" },
    },
    definitionExpression:
      "PROJ_TYP_NM <> 'Studies' AND (PIN_STAT_NM = 'Under Construction')",
  });
