...
// Source: Rene Rubalcava
// https://codepen.io/odoe/pen/rqXqVw
...
require([
    ...
    // Scope: These are assigned values in the functions below
    let map;
    let view;
    let csvLayer;
    let csvLayerView;
    ...
    // store the selected features from the sketch geometry
    let resultFeatures = [];
